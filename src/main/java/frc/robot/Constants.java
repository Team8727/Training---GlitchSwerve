...
public class Constants {
  ...
  public static class kSwerve {
    ...
    public static double maxTransSpeed = 1;  //5;
    public static double maxAngSpeed = 2;  //Math.PI; //3 * Math.PI;
    ...
    public static class SwerveJoystick {
  ...
  public static class kIntake {
    public static class kPivot {
      ...
      public enum IntakePosition {
        HOME( Math.PI /*(1.5 * Math.PI) /* Math.PI*/ ),
        DEPLOYED( 1.95 * Math.PI  /*0.05 + (Math.PI * 0.8) /* 0.05*/ ),  ///TUNEEEEEE
        EJECT( 1.5 * Math.PI); /// Have to edit this as well
